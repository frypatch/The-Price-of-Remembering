...
## Uncomment next line to force a major release.
...
<link rel="apple-touch-icon" sizes="180x180" href="''' + website + '''/book/icons/apple-touch-icon.png">
<link rel="icon" type="image/vnd.microsoft.icon" href="''' + website + '''/book/icons/favicon.ico"/>
<link rel="icon" type="image/png" sizes="32x32" href="''' + website + '''/book/icons/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="''' + website + '''/book/icons/favicon-16x16.png">
